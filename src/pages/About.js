...
export default function About (){
    return (
        <>
        <h2 style={{color: "darkgreen"}}> What is the Punyam Giving Tree? </h2>
        <ul id = "GivingTreeBulletPoints">
            <li> The Punyam Giving Tree is a community-based charitable initiative designed to bring
        ...
        <ul id = "HowItWorksBulletPoints">
            ...
            <li>Members of the punyam community select an mango from the tree</li>
